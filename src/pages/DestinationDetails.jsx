...
const destinationSeo = {
  'united-kingdom': {
    title: 'UK Visa Assistance in Chennai | CLW Visa Services',
    description:
      'UK visa assistance in Chennai for tourist, business and family travel to the United Kingdom.',
  },

  'united-states': {
    title: 'USA Visa Assistance in Chennai | CLW Visa Services',
    description:
      'USA visa documentation and application assistance in Chennai for eligible travellers.',
  },

  canada: {
    title: 'Canada Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Canada visa assistance in Chennai for visitor, business and study-related travel.',
  },

  'australia-new-zealand': {
    title:
      'Australia & New Zealand Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Visa assistance for travellers from Chennai planning trips to Australia and New Zealand.',
  },

  'schengen-countries': {
    title: 'Schengen Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Schengen visa assistance in Chennai for travel across participating European countries.',
  },

  'european-countries': {
    title: 'Europe Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Visa and travel assistance for European destinations from Chennai.',
  },

  'asian-countries': {
    title: 'Asia Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Visa assistance for travellers from Chennai visiting major destinations across Asia.',
  },

  'middle-east-countries': {
    title: 'Middle East Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Visa and travel assistance for business and family travel to Middle Eastern destinations.',
  },

  'african-countries': {
    title: 'Africa Visa Assistance in Chennai | CLW Visa Services',
    description:
      'Visa documentation and travel assistance for destinations across Africa.',
  },
}
...
export default function DestinationDetails() {
  ...
  const seo = destinationSeo[destination.slug]
  ...
  return (
    <>
      ...
      <SEO
        title={
          seo?.title ||
          `${destination.name} Visa Assistance in Chennai | CLW Visa Services`
        }
        description={
          seo?.description ||
            ...
            >
              <div className="relative h-[300px] overflow-hidden rounded-xl sm:h-[380px] lg:h-full lg:min-h-[470px]">
                ...
                <img
                  ...
                  alt={
                    destination.alt ||
                    `${destination.name} travel destination and visa assistance`
                  }
                  loading="lazy"
                  decoding="async"
